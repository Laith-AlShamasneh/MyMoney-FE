...
export const Config = Object.freeze({
  ...
  STORAGE_KEYS: Object.freeze({
    ...
    WORKSPACE_CONTEXT:     'mm.workspaceCtx',
    WORKSPACE_PERMS:       'mm.workspacePerms',
  }),
  ...
  ROUTES: Object.freeze({
    ...
    WORKSPACE_MEMBERS:      '/pages/workspaces/members.html',
    WORKSPACE_INVITATIONS:  '/pages/workspaces/invitations.html',
    WORKSPACE_ROLES:        '/pages/workspaces/roles.html',
    WORKSPACE_SETTINGS:     '/pages/workspaces/settings.html',
    WORKSPACE_ACCEPT:       '/pages/workspaces/accept.html',
  }),
  ...
  API: Object.freeze({
    ...
    WORKSPACE: Object.freeze({
      ...
      CONTEXT:             '/api/workspaces/context',
      MEMBERS_LIST:        '/api/workspaces/members/list',
      MEMBERS_UPDATE_ROLE: '/api/workspaces/members/update-role',
      MEMBERS_SUSPEND:     '/api/workspaces/members/suspend',
      MEMBERS_REINSTATE:   '/api/workspaces/members/reinstate',
      MEMBERS_REMOVE:      '/api/workspaces/members/remove',
      MEMBERS_LEAVE:       '/api/workspaces/members/leave',
      INVITATIONS_SEND:    '/api/workspaces/invitations/send',
      INVITATIONS_CANCEL:  '/api/workspaces/invitations/cancel',
      INVITATIONS_PREVIEW: '/api/workspaces/invitations/preview',
      INVITATIONS_ACCEPT:  '/api/workspaces/invitations/accept',
      INVITATIONS_REJECT:  '/api/workspaces/invitations/reject',
      INVITATIONS_LIST:    '/api/workspaces/invitations/list',
      PERMISSIONS_MY:      '/api/workspaces/permissions/my',
      ACTIVITY_LIST:       '/api/workspaces/activity/list',
    }),
